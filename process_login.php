...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT u.userID, u.empNo, u.emailaddr, u.userType, u.password, e.firstname, e.lastname 
            FROM users u 
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt->num_rows == 1) {
                ...
                $stmt->bind_result($id, $empNo, $emailaddr, $userType, $hashed_password, $firstname, $lastname);
                if ($stmt->fetch()) {

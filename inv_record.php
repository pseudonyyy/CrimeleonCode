        ...
        <table border='1'>
            ...
            <?php foreach ($data as $row): ?>
                <tr>
                    ...
                    <td>
                        <a href="change_status.php?id=<?php echo $row['data_id']; ?>&status=Approved" class="button" style="background-color: green; color: white; padding: 10px; text-decoration: none; border-radius: 5px;">Approve</a>
                        <a href="change_status.php?id=<?php echo $row['data_id']; ?>&status=Declined" class="button" style="background-color: red; color: white; padding: 10px; text-decoration: none; border-radius: 5px;">Decline</a> 
                    </td>
